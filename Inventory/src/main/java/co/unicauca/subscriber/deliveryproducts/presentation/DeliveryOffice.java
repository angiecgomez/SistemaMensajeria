...
public class DeliveryOffice extends javax.swing.JFrame implements ISubscriber {
    ...
    public DeliveryOffice() {
        ...
        InventarioLista.setModel(modelList);
    ...
    private void initComponents() {
        ...
        InventarioTexto = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        InventarioLista = new javax.swing.JList<>();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        InventarioTexto.setText("Inventario de Salidas");
        jPanel1.add(InventarioTexto);
    ...
    public void onMessage(String msg) {
      ...
      modelList.addElement(deliveryEntity.__str__());   
      InventarioLista.paintImmediately(InventarioLista.getBounds());
    }
    ...
    private javax.swing.JList<String> InventarioLista;
    private javax.swing.JLabel InventarioTexto;
